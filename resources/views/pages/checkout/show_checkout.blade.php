						...
						<div class="table-responsive cart_info">
							...
							<table class="table table-condensed">
								...
								<tr>
									...
									<td class="cart_quantity">
										<div class="cart_quantity_button">
											...
											<input class="cart_quantity_" type="number" 
								...
								<tr>
									...
									<td><a class="btn btn-default check_out" href="{{ route('processTransaction') }}">Paypal</a></td>
									<td>
							...
							<div class="form-one">
								<form method="POST">
									...
									@endif
										...
										@else
										<select name="payment_select" id="province" class="form-control input-sm m-bot15 payment_select">
												<option value="2">Thanh toán thành công bằng Paypal</option>
											</select>
										@endif
										</div>
